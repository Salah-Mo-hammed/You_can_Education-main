...
class _AuthWidgetState extends State<AuthWidget> {
  ...
  void _handleAuthState(BuildContext context, AuthState state) async {
    ...
    // ! older code (becaus eof multible push problem) 13-9-2025
    ...
    //       );
    //     }
    //     // new problem 13_9 (_TypeError (Null check operator used on a null value)) line 84 (multible push it seems)
    //     Navigator.pushReplacement(
    //       context,
    //       MaterialPageRoute(
    //         builder:
